...
--
-- Host: localhost:3306
-- Generation Time: Aug 08, 2023 at 10:24 AM
...
CREATE TABLE IF NOT EXISTS `amminities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `restaurent_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `restaurent_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guest_name` varchar(255) NOT NULL,
